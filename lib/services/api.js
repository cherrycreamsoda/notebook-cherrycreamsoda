...
export const notesAPI = {
  ...
  setPasskey: async (id, passkey) => {
    const result = await request(`/notes/${id}/passkey`, {
      method: "PUT",
  ...
  lockNote: async (id) => {
    const result = await request(`/notes/${id}/lock`, {
      method: "PUT",
    });
    return result.data;
  },

  unlockNote: async (id, passkey) => {
    const result = await request(`/notes/${id}/unlock`, {
      method: "PUT",
      body: JSON.stringify({ passkey }),
    });
    return result.data;
  ...
  hasPasskey: async (id) => {
    ...
    return result?.data?.hasPasskey === true;
  },
};
...
export const setPasskey = (id, passkey) => notesAPI.setPasskey(id, passkey);
export const lockNote = (id) => notesAPI.lockNote(id);
export const unlockNote = (id, passkey) => notesAPI.unlockNote(id, passkey);

export const hasPasskey = (id) => notesAPI.hasPasskey(id);
