export const extractPlainTextServer = (content) => {
  if (!content) return "";

  // If it's a string (plain text or HTML)
  if (typeof content === "string") {
    // Simple HTML to text conversion without DOM (for server-side or safe client-side)
    return content
